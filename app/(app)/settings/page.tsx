...
// Quiet, non-clickable label that organizes the single settings scroll into
// readable bands without turning into separate tabs/pages.
function GroupLabel({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider px-1 pt-3 first:pt-0">
      {children}
    </h2>
  );
}
  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl mx-auto pb-24 md:pb-8">
      ...
      <div className="space-y-4">
        {/* ── General ── */}
        <GroupLabel>{t('settings.sectionGeneral')}</GroupLabel>
        ...
        {/* ── Taxes & Payroll ── */}
        <GroupLabel>{t('settings.sectionTaxes')}</GroupLabel>
              ...
              <details className="group rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                <div className="p-4 border-t border-slate-200 dark:border-slate-700">
                  <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mb-3">
                    Update your filing status in <span className="font-bold">{t('settings.payrollDeductions')}</span> above to change these.
                  </p>
        ...
        {/* ── Categories ── */}
        <GroupLabel>{t('settings.sectionCategories')}</GroupLabel>
        ...
        {/* ── About & Data ── */}
        <GroupLabel>{t('settings.sectionAbout')}</GroupLabel>

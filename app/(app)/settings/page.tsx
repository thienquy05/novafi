...
import { Save, RotateCcw, ExternalLink, Plus, X, Info, Globe, RefreshCw, User, SlidersHorizontal, Receipt, Tags } from 'lucide-react';
...
type SectionId = 'general' | 'taxes' | 'categories';
...
export default function SettingsPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl mx-auto pb-24 md:pb-8">
      ...
      {/* Section nav — sticky pills, scrollable on mobile */}
      ...
      {section === 'general' && (
        <div className="space-y-6">
          ...
          <Card className="bg-indigo-50/50 border-indigo-100 dark:border-indigo-800/50">
            <CardHeader>
              <CardTitle className="text-indigo-900 dark:text-indigo-300">{t('settings.dataStorage')}</CardTitle>
            </CardHeader>

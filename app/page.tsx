...
export default async function LoginPage() {
  ...
  const features = [
    { Icon: TrendingUp, key: 'featureTracking' as const, color: 'text-indigo-500' },
    { Icon: Shield,     key: 'featurePrivate' as const,  color: 'text-emerald-500' },
    { Icon: Zap,        key: 'featureSync' as const,     color: 'text-amber-500' },
    { Icon: Target,     key: 'featureGoals' as const,    color: 'text-sky-500' },
  ];
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center gap-6 mb-12">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-500 text-lg font-medium">{t('login.tagline', lang)}</p>
          </div>
        </div>
        ...
        <div className="glass rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="space-y-3 mb-10">
              <h2 className="text-2xl font-bold text-slate-900 text-center tracking-tight">{t('login.welcomeBack', lang)}</h2>
            ...
            <div className="mt-10 grid grid-cols-2 gap-3">
              {features.map(({ Icon, key, color }) => (
                <div key={key} className="flex items-center gap-2.5 text-sm text-slate-600 font-medium">
